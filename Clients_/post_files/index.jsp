...
out.println("<td>"+pro_desc1+"</td>");
out.println("<td>"+pro_adddet1+"</td>");%>
<td><form action="del_pro.jsp" method="post"><input type="hidden" name="pid" value="<%=pro_pid1%>"><input class="myButton" type="submit"  value="DELETE"></form></td>
...
<div class="riga" style="padding:50px 0 0">
    ...
    <a class="fancybox"  id="image2" title="POST NEW PROJECT"><img src="data/work1.png" alt="Web template"></a>
    </div>


    <div class="colonna col3" >
    <a class="fancybox"  id="image2" title="VIEW PREVIOUS POSTED PROJECTS"><img src="data/work3.png" alt="Logo fantasy"></a>
    </div>

    <div class="colonna col3" >
    <a class="fancybox"  id="image2" title="VIEW PROJECT STATUS"><img src="data/work2.png" alt="Web template"></a>
    </div>
</div>

<div class="riga">
    <div class="colonna col3" >
    <a class="fancybox"  id="image2" title="DELETE A PROJECT"><img src="data/work4.png" alt="Logo fantasy"></a>
    </div>


    <div class="colonna col3" >
    <a class="fancybox"  id="image2" title="MODIFY A PROJECT"><img src="data/work5.png" alt="Logo Bar Nazionale"></a>
    </div>

    <div class="colonna col3" >
    <a class="fancybox"  id="image2" title="VIEW TOP DEVELOPERS"><img src="data/work6.png" alt="Mastarna disco pub"></a>
    </div>
</div>
